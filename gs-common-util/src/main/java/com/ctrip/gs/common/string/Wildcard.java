...
/**
 * Checks whether a string matches a given wildcard pattern. Possible patterns allow to match single characters ('?') or
 * any count of characters ('*'). Wildcard characters can be escaped (by an '\').
 * <p>
...
public final class Wildcard {
    ...
    /**
     * Checks if two strings are equals or if they {@link #match(String, String)}. Useful for cases when matching a lot
     * of equal strings and speed is important.
     */
